		...
		<Box>
          ...
          <Stack sx={styles.cardLayout} spacing={2}>
					<Box sx={styles.avatarBox}>
						<Avatar
							src={postDetail.imageUrl} alt="avatar" sx={styles.avatar}/>
						<Box>
							<CardContent sx={styles.cardContent}>{postDetail.username}</CardContent>
						</Box>
					</Box>
					<Box>
						<Typography sx={styles.titleText}>{postDetail.jobTitle}</Typography>
            <Typography sx={styles.dateText}>{postDetail.date}</Typography>
					</Box>
					<Box><Typography sx={styles.contentText}>{postDetail.description}</Typography></Box>
